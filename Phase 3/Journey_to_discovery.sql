...
--
-- Host: localhost:8889
-- Generation Time: Nov 25, 2024 at 06:33 AM
...
(111, 111, 'Fuji Mountain', 'Honshu, Japan', 'A visit to Mount Fuji offers breathtaking views of Japan\'s iconic peak, rising majestically above the clouds. Surrounded by serene lakes and lush forests, it\'s a peaceful retreat for both adventure seekers and nature lovers.', 'mountain.jpg'),
...
(444, 383, 'Central Park', 'New York, Manhattan', 'Central Park is a vast, iconic urban park in New York City, with lush landscapes, scenic paths, lakes, and landmarks, offering a peaceful retreat in the heart of Manhattan.', 'Park.jpg'),
(445, 383, 'The Emoire State Building', 'New York', 'The Empire State Building is a world-famous, 102-story skyscraper in New York City, renowned for its Art Deco design and breathtaking views from its observation decks.', 'Empire.jpeg'),
(446, 384, 'Old Town', 'Nice', 'is a colorful nook of a neighborhood enjoyed by both travelers and locals alike for its narrow shop-lined streets and atmosphere.', 'Nice.webp'),
(447, 384, 'Lake Annecy', 'Annecy', 'Lake Annecy is one of the largest lakes in France; and it is one of the most attractive lakes in Europe', 'lake.jpeg'),
(448, 385, 'Tokyo Disneyland', 'Tokyo', 'Tokyo Disneyland is a magical theme park in Japan inspired by classic Disney characters and stories, featuring thrilling rides, parades, and immersive attractions.', 'Disneyland.png'),
(449, 386, 'Kingdom Tower', 'Riyadh', 'Kingdom Tower, is a striking skyscraper in Riyadh, Saudi Arabia, known for its unique architectural design, sky bridge, and panoramic city views.', 'kingdom.jpeg'),
(450, 386, 'The Beach', 'Al-Khobar', 'Al Khobar Beach is a serene coastal destination in Saudi Arabia, featuring sandy shores, clear waters, and scenic views of the Arabian Gulf, ideal for relaxation and family outings', 'beach.jpg');
...
(111, 'Mohammed', 'Saleh', 'Msaleh@gmail.com', '$2a$12$CiE7W65G3W4I0.fmrHl8qOvv.svJ7Rv/nHPRrvqvjqBMTL.uJCco6', 'User_photo1.jpg'),
(222, 'Sarah', 'Ahmad', 'Sahmad@gmail.com', '$2a$12$XoRpRXGl.veRFf8N7YTbWuTUq4qQc3vGQ8ubxEdDZTglH93pMF.RW', 'User_photo2.png'),
(333, 'Eman', 'Saleh', 'Esaleh@gmail.com', '$2a$12$/KX8jXZtFYvro0ExRaWMi.fHuyTmVhzQGXJoTeaR4H2eWnY2KZHc2', 'User_photo3.jpg'),
...
--
ALTER TABLE `Travel`
  MODIFY `id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33334;
